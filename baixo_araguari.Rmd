...
```{r fig-dynamic, fig.cap="Dinâmica da cobertura fluvial. Mudanças na configuração da cobertura hídrica na paisagem de 1985 a 2020. Valores anuais de Coesão calculados em 1 km tampões em torno de 50 pontos regularmente espaçados entre os rios Amazonas e Araguari."}
