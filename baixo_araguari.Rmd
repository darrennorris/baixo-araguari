...
# buffers 500 m Rio Urucurituba
rios_points_buffers_500m <- sf::st_read(meuSIG, layer = "rios_points_buffers") %>% 
  filter(buff_dist ==500, nome_rio == "Rio Urucurituba")
...
```{r calc-metrics, message=FALSE, warning=FALSE}
# Metricás 
...
```{r fig-dynamic, fig.cap="Dinâmica da cobertura fluvial. Mudanças na configuração da cobertura hídrica na paisagem entre 1985 a 2020. Valores anuais de Coesão (Cohesion) calculados em buffers (raios de 500, 1000 e 2000 metros) em torno de 50 pontos regularmente espaçados entre os rios Amazonas e Araguari."}
